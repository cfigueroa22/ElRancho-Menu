    ...
    >
      <div className="py-3 bg-lightGray ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            (Ranch style eggs) Tow eggs, topped with Mexican sauce. Served with
      ...
      <div className="py-3 ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Large flour tortilla filled with rice, beans, chorizo, chicken, and
            beef. Topped with Pico de Gallo and melted cheese.
          </p>
        </div>
      </div>
      <div className="py-3 bg-lightGray">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Large flour tortilla filled with strips of beef or chicken, onions,
            bell peppers, tomatoes, and topped with melted cheese.
          </p>
        </div>
      </div>
      <div className="py-3">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Made with chunks of beef or pork, topped with lettuce, tomatoes, and
            sour cream.
          </p>
        </div>
      </div>
      ...
      <div className="py-3">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Two flour tortillas rolled up and stuffed with shredded beef, pork,
            or chicken. Covered with melted cheese (served fried or soft).
          </p>
        </div>
      </div>
      <div className="py-3 bg-lightGray">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            ...
            chicken. Covered with melted cheese and topped with lettuce, tomato,
            sour cream, and guacamole. (served fried or soft)
          </p>
        </div>
      </div>
      <div className="py-3">
      ...
      <div className="py-3">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            ...
            onions, bell peppers, and enchilada sauce. Served with guacamole and
            rice.
          </p>
        </div>
      </div>
      ...
      <div className="py-3 ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Large flour tortilla stuffed with cheese, chicken, steak, and shrimp
            grilled with onions, green peppers, and tomatoes. With lettuce, sour
            cream, and guacamole.
          </p>
        </div>
      </div>
      ...
      <div className="py-3 ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Choice of chopped steak or chicken, green pepper, onions, tomatoes,
            and spices simmered together. Served with rice, beans, and
            tortillas.
          </p>
        </div>
      </div>
      ...
      <div className="py-3 bg-lightGray">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            ...
            cooked with tomatoes, onions, and bell peppers. Served with lettuce,
      ...
      <div className="py-3 ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            One each: Chalupa, chile relleno, beef taco, enchilada, and tamale.
      ...
      <div className="py-3 ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Large fried flour tortilla shell filled with grilled shrimp. Cooked
            with onions, tomatoes, and bell peppers. Covered with lettuce, sour
            cream, and cheese.
          </p>
        </div>
      </div>
      ...
      <div className="py-3 ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Four rolled corn tortillas stuffed with beef or chicken. Served with
