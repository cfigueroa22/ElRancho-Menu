...
const Lunch = () => {
  return (
    <div
      id="menu"
      className="fixed inset-0 z-40 overflow-y-auto transition-all duration-500 ease-in-out bg-white top-14 lg:mx-32 drop-shadow-xl "
    >
      ...
      <div className="py-3 bg-lightGray font-nunito">
        ...
        <div className="px-2 md:text-lg">
          <p>
            (Ranch style eggs) Two eggs, Mexican sauce on top, rice, beans, and
            tortillas.
          </p>
        </div>
      </div>
      <div className="py-3 font-nunito">
        ...
        <div className="px-2 md:text-lg">
          <p>Chicken or beef fajitas served with beans, rice, and tortillas.</p>
        </div>
      </div>
      <div className="py-3 bg-lightGray font-nunito">
        <div className="flex justify-between px-2">
      ...
      <div className="py-3 bg-lightGray font-nunito">
        ...
        <div className="px-2 md:text-lg">
          <p>
            Two scrambled eggs with Mexican sausage served with rice, beans, and
            tortillas.
          </p>
        </div>
      </div>
