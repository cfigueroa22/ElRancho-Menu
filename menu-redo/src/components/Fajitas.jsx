    ...
    >
      ...
      <div className="py-3 bg-lightGray">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Chicken or beef cooked with onions, tomato, and bell pepper. Served
      ...
      <div className="py-3 ">
        ...
        <div className="px-2 font-nunito md:text-lg">
          <p>
            Chicken and beef cooked with onions, tomato, and bell pepper. Served
            with beans, lettuce, tomato, guacamole, and tortillas.
          </p>
        </div>
      </div>
      ...
      <div className="py-3 bg-lightGray ">
        ...
        <div className="flex justify-between px-2 font-semibold font-arimo">
          <div className="flex">
            <p className="text-xl md:text-3xl">Fajitas El Rancho for two (2)</p>
          </div>
